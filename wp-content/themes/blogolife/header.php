...
<link rel="alternate" type="application/rss+xml" title="Pianeta Italia | Blog &raquo; Beslemesi" href="http://www.pianeta-italia.com/blog/feed/" />
<link rel="alternate" type="application/rss+xml" title="Pianeta Italia | Blog &raquo; Yorum Beslemesi" href="http://www.pianeta-italia.com/blog/comments/feed/" />
		
<link rel='stylesheet' id='style-green-css'  href='http://www.pianeta-italia.com/blog/wp-content/themes/blogolife/images/green/style.css?ver=4.4.2' type='text/css' media='all' />
<link rel='stylesheet' id='oswald-css'  href='http://fonts.googleapis.com/css?family=Oswald&#038;v2&#038;ver=4.4.2' type='text/css' media='all' />
<script type='text/javascript' src='http://html5shim.googlecode.com/svn/trunk/html5.js?ver=4.4.2'></script>
<link rel='https://api.w.org/' href='http://www.pianeta-italia.com/blog/wp-json/' />
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://www.pianeta-italia.com/blog/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="http://www.pianeta-italia.com/blog/wp-includes/wlwmanifest.xml" /> 
<meta name="generator" content="WordPress 4.4.2" />
		<style type="text/css">.recentcomments a{display:inline !important;padding:0 !important;margin:0 !important;}</style>
		<style type="text/css" id="custom-background-css">
body.custom-background { background-image: url('http://www.pianeta-italia.com/blog/wp-content/themes/blogolife/images/bg.png'); background-repeat: repeat; background-position: top left; background-attachment: scroll; }
</style>
</head>
...
<div id="page"<?php if (is_single() || is_page() ) { $sidebar = get_post_meta($post->ID,'wpl_enable_sidebar',true);  if($sidebar=="false") echo ' class="template-full-widch"'; } ?>>
	<header id="branding">
<hgroup class="fleft">
	<h1 id="site-title"><a href="http://www.pianeta-italia.com/blog/?blog" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?> - <?php bloginfo('description'); ?>" rel="home"><?php bloginfo('name'); ?></a></h1>
...
<nav>
	...
	<div class="menu-wplook-main-menu-container">
		<ul id="menu-wplook-main-menu" class="menu">
			<li id="menu-item-534" class="menu-item menu-item-type- menu-item-object- menu-item-534"><a href="/blog/category/italyada-dil-kurslari/">İtalya’da Dil Kursları</a></li>
			<li id="menu-item-530" class="menu-item menu-item-type- menu-item-object- menu-item-530"><a href="/blog/category/italyada-universite/">İtalya’da Üniversite</a></li>
<li id="menu-item-531" class="menu-item menu-item-type- menu-item-object- menu-item-531"><a href="/blog/category/italyada-tasarim-akademileri/">İtalya’da Tasarım Akademileri</a></li>
<li id="menu-item-532" class="menu-item menu-item-type- menu-item-object- menu-item-532"><a href="/blog/category/italyada-staj-programlari/">İtalya’da Staj Programları</a></li>
